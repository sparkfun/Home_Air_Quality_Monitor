...
void hV_Screen_Buffer::drawDigitSmall(uint8_t number, uint16_t x_location, uint16_t y_location) 
{
    ...
    {
        {
            //Image Name: 0.png ; Width: 24 ; Height: 40
            0xff,0xff,0xff, // 1
            0xff,0xff,0xff, // 2
            0xff,0xc7,0xff, // 3
            0xfe,0x00,0xff, // 4
...
0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff,0xff, // 1
    ...
    if(sensor == mySensor.nox) partialScreenBitmap(baseline_x+22, 10, nox_bitmap_car, 69, 104);
    if(sensor == mySensor.particles) partialScreenBitmap(baseline_x+22, 10, particles_text, 69, 104);
    if(sensor == mySensor.voc) partialScreenBitmap(baseline_x+22, 10, voc_bitmap, 69, 104);
    if(sensor == mySensor.ch4) partialScreenBitmap(baseline_x+22, 10, ch4_text_below, 69, 104);
    if(sensor == mySensor.aqi) partialScreenBitmap(baseline_x+22, 10, aqi_bitmap, 69, 104);
    if(sensor == mySensor.tempBig) partialScreenBitmap(baseline_x+22, 10, temperature_text, 69, 104);
    if(sensor == mySensor.humidityBig) partialScreenBitmap(baseline_x+22, 10, humidity_text, 69, 104);
