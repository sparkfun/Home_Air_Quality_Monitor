...
void hV_Screen_Buffer::updateFrameVal(uint8_t frameNumber, uint8_t sensor, float sensorReading) {
    ...
    if(sensor == mySensor.humidity) drawNumBig(String(sensorReading), baseline_x+50, 90, numDigits);
    else if (sensor == mySensor.temperature) drawNumBig(String(sensorReading), baseline_x+50, 3, numDigits);
    else drawNumBig(String(sensorReading), baseline_x+22, 90, numDigits);
}
