...
/// @copyright Creative Commons Attribution-ShareAlike 4.0 International (CC
/// BY-SA 4.0)
///
/// The highView Library Suite is shared under the Creative Commons licence
...
///
/// @n Consider the Evaluation or Commercial editions for professionals or
/// organisations and for commercial usage
///
...
/// @details This class provides the text and graphic primitives for the
/// buffered screen
///
...
public:
  ...
  ///
  virtual void circle(uint16_t x0, uint16_t y0, uint16_t radius,
                      uint16_t colour);
  ...
  /// @n @b More: @ref Coordinate, @ref Colour
  ///
  virtual void dLine(uint16_t x0, uint16_t y0, uint16_t dx, uint16_t dy,
                     uint16_t colour);
  ...
  /// @n @b More: @ref Coordinate, @ref Colour
  ///
  virtual void triangle(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2,
  ...
  /// @n @b More: @ref Coordinate, @ref Colour
  ///
  virtual void rectangle(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2,
                         uint16_t colour);
  ...
  /// @n @b More: @ref Coordinate, @ref Colour
  ///
  virtual void dRectangle(uint16_t x0, uint16_t y0, uint16_t dx, uint16_t dy,
                          uint16_t colour);
  ...
  ///
  virtual void gText(uint16_t x0, uint16_t y0, String text,
                     uint16_t textColour = myColours.black,
                     uint16_t backColour = myColours.white);
  /// @}

  virtual void drawDigitBig(uint8_t number, uint16_t x_location,
                            uint16_t y_location);

  virtual void drawNumBig(String number, uint16_t x_location,
                          uint16_t y_location);

  virtual void partialScreenBitmap(uint16_t x_location, uint16_t y_location,
                                   uint8_t *bitmap, uint16_t width,
                                   uint16_t height,
  ...
  virtual void updateFrameVal(uint8_t frameNumber, uint8_t sensor,
                              String sensorReading);

  virtual void drawText(int x, int y, int fontSize, String msg,
                        String color = "black");

  virtual void clearNumDigit(uint8_t numDigit, uint16_t x_location,
                             uint16_t y_location);
...
protected:
  ...
  ///
  virtual void _setPoint(uint16_t x1, uint16_t y1,
                         uint16_t colour) = 0; // compulsory
  ...
  /// @param colour 16-bit colour
  ///
  void _triangleArea(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2,
                     uint16_t x3, uint16_t y3, uint16_t colour);
  ...
  uint16_t _screenSizeH, _screenSizeV, _screenDiagonal, _screenMarginH,
      _screenMarginV;
